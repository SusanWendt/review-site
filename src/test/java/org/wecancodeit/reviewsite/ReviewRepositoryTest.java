...
public class ReviewRepositoryTest {
	...
	private Review firstReview = new Review(firstReviewId, "title", "name", "imageUrl", "reviewCategory", "content",
			"date", "description");

	private long secondReviewId = 33L;
	private Review secondReview = new Review(secondReviewId, "title", "name", "imageUrl", "reviewCategory", "content",
			"date", "description");
